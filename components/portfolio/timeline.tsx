...
const experiences = [
  {
    ...
    company: "HackQuest",
    period: "2025 - Present",
    description: "Leading developer advocacy initiatives, mentorship, and ecosystem contribution. Helping developers onboard into blockchain development.",
    icon: Megaphone,
    tags: ["Web3", "Mentorship", "Ecosystem", "Developer Support"],
  },
  {
    title: "Volunteer",
    company: "CoinferenceX",
    period: "2025 - Present",
    description: "Supported planning and execution of a Web3 conference.",
    icon: Globe,
    tags: ["Web3", "Conference", "Operations"],
  },
  {
  ...
  },
  {
    ...
    description: "Organized 2 small-scale offline Web3 hackathons and 1 large-scale flagship hackathon. Designed and launched an event management platform with registration, scheduling, and live updates.",
    icon: Briefcase,
    tags: ["Web3", "Event Management", "Team Lead"],
  },
]
